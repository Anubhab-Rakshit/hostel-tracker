...
import { NeumorphicSidebarStats } from "@/components/dashboard/neumorphic-sidebar-stats";
      ...
      >
        <div className="flex h-full flex-col glass-ultra border-r border-white/20 dark:border-gray-800/50">
          ...
          <div className="flex h-20 items-center justify-between px-5 border-b border-gray-200/50 dark:border-gray-700/30">
            <Link href="/" className="flex items-center gap-3 group">
              <div className="relative group-hover:scale-105 transition-transform">
                <img src="/logo.png" alt="Logo" className="h-11 w-11 object-contain drop-shadow-[0_0_15px_rgba(168,85,247,0.5)]" />
              </div>
              {isSidebarOpen && (
                <motion.div
          ...
          <ScrollArea className="flex-1 px-3 py-6">
            {/* Story Feed Injection */}
            {isSidebarOpen && (
              <div className="mb-6 px-1">
                <h4 className="text-xs font-bold text-zinc-500 uppercase tracking-wider mb-2 px-2">Stories</h4>
                <StoryFeed />
              </div>
            )}
            ...
            {/* Neumorphic Stats Injection */}
            {isSidebarOpen && <NeumorphicSidebarStats />}
